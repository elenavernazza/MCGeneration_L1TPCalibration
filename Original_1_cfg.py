...
# with command line options: Configuration/GenProduction/python/JME-RunIIFall18wmLHEGS-00006-fragment.py --python_filename MC_Step0_GEN_HT200to300_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --step LHE,GEN,SIM --fileout file:Ntuple_GEN_0.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JME-RunIIFall18wmLHEGS-00006-fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Ntuple_GEN_0.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Ntuple_GEN_0_inLHE.root'),
