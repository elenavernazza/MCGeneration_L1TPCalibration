...
# with command line options: step2 --filein file:step1.root --fileout file:step2.root --mc --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --step RAW2DIGI,L1Reco,RECO --conditions 126X_mcRun3_2023_forPU65_v1 --python_filename MC_Step2_AOD_QCD_Pt30to500_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:'+str(options.maxEvents)),
