...
if __name__ == "__main__" :
    ...
    parser.add_option("--maxEvents", dest="maxEvents", type=int,            default=100,                             help="Number of events per job")
    ...
    for idx in range(options.nJobs):
        ...
        cmsRun = "cmsRun MC_Step0_GEN_QCD_Pt20to500_flatPt_cfg.py outputFile=file:"+outRootName
