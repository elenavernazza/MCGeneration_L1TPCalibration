...
# with command line options: Configuration/GenProduction/python/TSG-Run3Summer21GS-00003-fragment.py --python_filename TSG-Run3Summer21GS-00003_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:TSG-Run3Summer21GS-00003.root --conditions 126X_mcRun3_2023_forPU65_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 1000
...
# print('My print',options.outputFile, options.maxEvents, options.globalTag, options.randseed)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Run3Summer21GS-00003-fragment.py nevts:'+str(options.maxEvents)),
